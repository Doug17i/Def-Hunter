...
prediction_dir = '../output/prediction/Def_Hunter/within-release/'
...
deepline.dp.result = get.file.level.eval.result(prediction_dir, "FSLDP")

# all.result = rbind(bi.lstm.result, cnn.result, dbn.result, lr.result, deepline.dp.result)
all.result = rbind(bi.lstm.result, cnn.result, dbn.result, bow.result, deepline.dp.result)
...
deepline.dp.line.result$technique = 'FSLDP'
...
#  file.level.by.project
write.csv(file.level.by.project, file = "file_level_by_project.csv", row.names = FALSE)

#  line.level.all.mean.by.project
write.csv(line.level.all.mean.by.project, file = "line_level_all_mean_by_project.csv", row.names = FALSE)
...
write.csv(final.line.level.result, file = "final_line_level_result.csv", row.names = FALSE)

write.csv(final.file.level.result, file = "final_file_level_result.csv", row.names = FALSE)