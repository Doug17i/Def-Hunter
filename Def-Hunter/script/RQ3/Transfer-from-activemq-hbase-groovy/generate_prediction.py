...
save_model_dir = '../../../output/model/Def_Hunter/'
intermediate_output_dir = '../../../output/intermediate_output/Def_Hunter/within-release/'
...
def predict_defective_files_in_releases(dataset_name, target_epochs):
    ...
    train_rel_all.append(all_train_releases['groovy'])
    train_rel_all.append(all_train_releases['hbase'])
    train_rel_all.append(all_train_releases['activemq'])
    train_rel_all.append(all_train_releases[dataset_name])
